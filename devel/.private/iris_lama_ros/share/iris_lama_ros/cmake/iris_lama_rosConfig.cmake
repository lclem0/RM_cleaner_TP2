...
if("TRUE" STREQUAL "TRUE")
  set(iris_lama_ros_SOURCE_PREFIX /home/lclem0/RM/rm_cleaner_ws/src/iris_lama_ros)
  set(iris_lama_ros_DEVEL_PREFIX /home/lclem0/RM/rm_cleaner_ws/devel/.private/iris_lama_ros)
  ...
  set(iris_lama_ros_INSTALL_PREFIX /home/lclem0/RM/rm_cleaner_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'iris_lama_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lclem0/RM/rm_cleaner_ws/src/iris_lama_ros/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lclem0/RM/rm_cleaner_ws/devel/.private/iris_lama_ros/lib;/home/lclem0/RM/rm_cleaner_ws/devel/lib;/opt/ros/noetic/lib)
